...
public class Mensagem {
	...
	public static String informeCelular = "Informe um numero de celular";
	public static String informeEmail = "Informe o endereço de e-mail";
	...
	public static String celularVazio = "Informe o numero de celular, campo obrigatório!";
	public static String emailVazio = "Informe o endereço de e-mail, campo obrigatório!";
	...
	public static String erroCadastroProfessor = "Para cadastrar o professor, cadastre primeiro a materia";

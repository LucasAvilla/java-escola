...
public class GerenciaEscola {
	...
	public void cadastrarMateria() {
		materias.add(getMateria());//Adiciona as matérias atevés do getMateria
	...
	public void cadastrarProfessor() {
		...
		if (materias.size() > 0) {//Condição para cadastrar um professor
			professores.add(getProfessor());//Adiciona o professor atevés do getProfessor
	...
	public void cadastrarTurma() {
		...
		if (professores.size() > 0 && alunos.size() > 0) {//Condição para formar uma turma (ALUNOS + PROFESSORES)
			turmas.add(getTurma());
	...
	public void listarAlunos() {
		...
		for (Aluno aluno : alunos) {//Varrer os alunos cadastrados
			existe = true;
	...
	public void consultarTurma() {
		...
		JOptionPane.showMessageDialog(null, mensagem, Rotulo.consultaDeTurmas, 1);
	}
	...
	//Método para retornar o codigo de uma materia
	private int getCodigoMateria() {
		...
		while (execute) {
			try {
				...
				if (Valida.isIntZero(codigo)) {//Valida se o argumento é igual a 0 (util - Valida)
	...
	//Método para retornar o nome de uma materia
	...
	//CONJUNTO DE MÉTODOS PARA CAPRTURAR OS DADOS REFERENTE AO ALUNO
	
	//Método para retornar o codigo de um aluno
	...
	//Método para retornar o nome de aluno
	...
	//Método para retornar o rg do aluno
	...
	//CONJUNTO DE MÉTODOS PARA CAPRTURAR OS DADOS REFERENTE A ENDEREÇO
	...
	//CONJUNTO DE MÉTODOS PARA CAPRTURAR OS DADOS REFERENTE A CONTATO
	...
	//CONJUNTO DE MÉTODOS PARA CAPRTURAR OS DADOS REFERENTE AO PROFESSOR
	...
	//CONJUNTO DE MÉTODOS PARA CAPRTURAR OS DADOS REFERENTE A CONSULTA DE TURMAS
